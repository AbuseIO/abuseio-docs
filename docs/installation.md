...
If you're running PHP7 or later then you must install BCmath and MBstring manually, as its no longer a part of the default installation:

```bash
apt-get install php7.0-bcmath php7.0-mbstring
```
